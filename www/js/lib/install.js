...
define(function (require) {
    ...
    function triggerChange(state) {
        console.log('state changed: ' + install.state);
        install.state = state;
    ...
    /* Mozilla/Firefox packaged app installation */
    install.mozillaInstallUrl = location.href + 'package.webapp';

    install.mozillaInstall = function () {
        if (navigator.mozApps.installPackage) {
          var installRequest = navigator.mozApps.installPackage(install.mozillaInstallUrl);
